...
public class Shell {
    ...
    public Shell() throws InterruptedException, FileNotFoundException, IOException, OpenDataException {
      ...
      boolean cokolwiek = false;
        ...
        Commands.put("RP", 1); ///Recznie zmien stan procesu z waiting na ready
...
//                }
               ...
               /// break;}
                ...
                case "DP": {
                    try {
                        ///Usuń proces
                        ProcesManagerr.set_state(ProcesManagerr.get_proces(Parameters[0]).get_ID(), 2);
                    } catch (Exception ex) {
                        System.out.println(ex.getMessage());
                    }
                    break;
                ...
                case "TS":{
                int li=0;
                if (ProcesManagerr.get_page_table(Parameters[0])!=null){
                    ...
                    li++;
                    }} else System.out.println("Nie ma takiego procesu!");
                ...
                case "CF": { ///Zamknij plik
                    ...
                    } else System.out.println("Plik u" + Parameters[0] + " nie udalo sie zamknac!");
                    break;}
                ...
                case "RP": { ///Zmien z waiting na ready 
                    
                    String a = Parameters[0];
                    
                     for(int i = 0 ; i < FileSystem.listaZamkow.size() ; i++)
                          {
                              FileSystem.listaZamkow.get(i).zamek.releaseProcess(a);
                          }
                    
                    
                    for(Iterator<Queue> iterat = Communication.queues.iterator(); iterat.hasNext();)
                    {
                        Queue data = iterat.next();
                        data.lock.releaseProcess(a);
                    }
                ...
                case "HP": {
                     ...
                     System.out.println("RP nazwa              -  Zmien recznie stan procesu oczekujacego na gotowy");
            ...
            NewCom = NewCom.toUpperCase();
                ...
                switch (NewCom.charAt(0)) {
                    ...
                    case 'N':
                        ...
                        if (in.hasNextLine()){
                            line = in.nextLine();}
                        else {System.out.println("Nie ma więcej komend do wykonania! Wyświetlimy okno pomocy!");
                        line = "HP";}
                        break;
                    case 'E':
                        cokolwiek = true;
