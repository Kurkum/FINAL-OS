			...
			ref.czas_dodania=czas_bezwzgledny;
                        ...
                        if(Runnable_proces_Queue.isEmpty())
                        {
                            ...
                            Runnable_proces_Queue.add(ref);
                             //System.out.println("Specjalny przypadek kiedy jest jeden proces i kolejka byla wczesjniej pusta");
                           scheduler();
                        }else {
               ...
               //obliczanie vruntime
                ...
                //(najwiekszy priorytet+1-najmniejszy)*(20/prior) zaokroglone do inta
                  int b=Runnable_proces_Queue.get(i).base_priority;
                   ...
                   else    Runnable_proces_Queue.get(i).vruntime=(int)((a-b)*(20.0/prior));
...
//                 }
       }else Running.running=manager.get_proces_bezczynnosci().get_PCB();
   }
